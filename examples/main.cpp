...
int main()
{
    ...
    vault1.root()->open_subview("vol1")->create_link_subnode("2", "vol1.8");
    vault1.root()->open_subview("vol1.2.4")->set_value("kk", "vv");
    vault1.root()->open_subview("vol1.2")->delete_subnode("4");

    vault1.load_subnode("vol2", "vol2.vol");
    vault1.root()->open_subview("vol2")->create_link_subnode("2", "vol2.7");
